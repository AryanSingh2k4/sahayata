        ...
        <div className="flex items-center gap-2">
          {!isAuthenticated && (
            <button
              ...
              className="inline-flex items-center px-3.5 py-2 rounded-[8px] border border-[#6DD9A8] bg-white hover:bg-[#A9F1CA]/20 text-[#00482F] text-xs font-medium transition-all shadow-sm"
            >
              <span>Sign In</span>
            </button>
          )}
